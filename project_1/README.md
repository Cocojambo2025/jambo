...
### Выводы:  
Программа, отгадывающая задуманное число, дает удовлетворительный результат - 7 попыток.
(Задача была - написать программу, которая находила бы число меньше чем за 20 попыток)
